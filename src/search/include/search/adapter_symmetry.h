...
template <typename Plant,
		  ...
		  typename QuoLoc = LocationT>
class get_next_canonical_words_symmetry
{
public:
	...
	get_next_canonical_words_symmetry([[maybe_unused]] const std::set<ActionType> &controller_actions  = {},
							 ...
							 [[maybe_unused]] const std::map<std::string, tacos::logic::AtomicProposition<std::string>> &action_map = {})
	{
	}
